...
class DatasetBuilder:
    ...
    def build(self) -> dict[str, DataFrame]:
        ...
        try:
            ...
            self._static_data_cache.close()
            self._dynamic_data_cache.close()
    ...
    def _build_dataframe(self) -> pd.DataFrame:
        ...
        for i, wheat_field in enumerate(wheat_fields):
            ...
            if str(wheat_field) in self.wheat_fields_to_exclude:
    ...
    def _divide_in_splits(self, data: pd.DataFrame, use_group_id_backup_col: bool = True) -> Dict[str, pd.DataFrame]:
        ...
        splits = self.ds_splits or self.ds_splits_generator.generate_splits(list(set(data[col_to_use])))
