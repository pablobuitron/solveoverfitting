...
class SplitsGenerator(metaclass=abc.ABCMeta):
    ...
    @staticmethod
    def _split_train_val_test(input_list: list, train_split_ratio: float, val_split_ratio: float) -> tuple[list, list, list]:
        train_split_index = round(len(input_list) * train_split_ratio)
        val_split_index = train_split_index + round(len(input_list) * val_split_ratio)

        train_split = input_list[:train_split_index]
        val_split = input_list[train_split_index:val_split_index]
        test_split = input_list[val_split_index:]
